...
public class ReporteSegundaNotificacionFijaConsThread implements Job{
	private Logger logger = Logger.getLogger(ReporteSegundaNotificacionFijaConsThread.class);
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		String callSegundaNotFijaCons = map.getString("callSegundaNotFijaCons");
		...
		String prefijoReporteSegundaNotFijaCons = map.getString("prefijoReporteSegundaNotFijaCons");
		...
		String callActualizarSegundaNotFijaCons = map.getString("callActualizarSegundaNotFijaCons");
		String daysSegundaNotificacion = map.getString("daysSegundaNotificacion");

		
		
		
		
		processreporteSegundaFacturaFijaCons(fileOutputFechaReporteSegundaNotificacion, DatabaseDataSourceIntegrador,callSegundaNotFijaCons, 
				WSLAuditoriaBatchAddress,WSLAuditoriaBatchTimeOut,BatchName, path, fileOutputReporteSegundaNot, 
				prefijoReporteSegundaNotFijaCons, fileProccess, processOutputReporteSegundaNot,callActualizarSegundaNotFijaCons,daysSegundaNotificacion,uid);
		
	}
	
	public void processreporteSegundaFacturaFijaCons(String fileOutputFechaReporteSegundaNotificacion,String DatabaseDataSourceIntegrador, 
												String callSegundaNotFijaCons, String wSLAuditoriaBatchAddress,
												String wSLAuditoriaBatchTimeOut, String batchName, String path, String fileOutputReporteSegundaNot,
												String prefijoReporteSegundaNotFijaCons, String fileProccess, 
												String processOutputReporteSegundaNot, String callActualizarSegundaNotFijaCons,String daysSegundaNotificacion,String uid){
		OracleCallableStatement cs = null;
		Database _database = null;

		try {
			_database = Database.getSingletonInstance(DatabaseDataSourceIntegrador, null,uid);
			_database.setCall(callSegundaNotFijaCons);
			...
			int diasSegundaNot=0;
			if(daysSegundaNotificacion!=null)
				diasSegundaNot=Integer.parseInt(daysSegundaNotificacion);
			...
			if (cs != null) {
				...
				if("TRUE".equals(result)){
					...
					if(rs.next()){
						String nombreArchivo = String.format(prefijoReporteSegundaNotFijaCons,new Date());
						...
						do {
							...
							fechaActualH.add(Calendar.DAY_OF_MONTH, -diasSegundaNot);
				...
				this.executeCall(callActualizarSegundaNotFijaCons, null,null,DatabaseDataSourceIntegrador,uid);
			}
