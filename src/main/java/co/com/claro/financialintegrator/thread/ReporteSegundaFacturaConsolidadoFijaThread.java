...
public class ReporteSegundaFacturaConsolidadoFijaThread implements Job{
	private Logger logger = Logger.getLogger(ReporteSegundaFacturaConsolidadoFijaThread.class);
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		String callSegundaFacturaConsolidadoFija = map.getString("callSegundaFacturaConsolidadoFija");
		...
		String prefijoReporteSegundaFacturaConsolidadoFija = map.getString("prefijoReporteSegundaFacturaConsolidadoFija");
		...
		String callTruncateSegundaFacturaConsolidadoFija = map.getString("callTruncateSegundaFacturaConsolidadoFija");

		
		
		processreporteSegundaFacturaMovil(fileOutputFechaReporteSegundaFactura, DatabaseDataSourceIntegrador,callSegundaFacturaConsolidadoFija, 
				WSLAuditoriaBatchAddress,WSLAuditoriaBatchTimeOut,BatchName,path,
				fileOutputReporteSegundaFactura,prefijoReporteSegundaFacturaConsolidadoFija,fileProccess,processOutputReporteSegundaFactura,
				callTruncateSegundaFacturaConsolidadoFija,uid);
	...
	public void processreporteSegundaFacturaMovil(String fileOutputFechaReporteSegundaFactura,String DatabaseDataSourceIntegrador, 
												String callSegundaFacturaConsolidadoFija,  
												String wSLAuditoriaBatchAddress, String wSLAuditoriaBatchTimeOut, String batchName,
												String path,String fileOutputReporteSegundaFactura,String prefijoReporteSegundaFacturaConsolidadoFija,
												String fileProccess, String processOutputReporteSegundaFactura,
												String callTruncateSegundaFacturaConsolidadoFija,String uid){
		...
		try {
			...
			_database.setCall(callSegundaFacturaConsolidadoFija);
			...
			if (cs != null) {
				...
				if("TRUE".equals(result)){
					...
					if(rs.next()){
						String nombreArchivo = String.format(prefijoReporteSegundaFacturaConsolidadoFija,new Date());
				...
				logger.info("Tiempo de escritura"+estimatedTime);
					...
					registrar_auditoriaV2("CONSOLIDADO FIJA", "No se pudo ejecutar el reporte consolidado",wSLAuditoriaBatchAddress, wSLAuditoriaBatchTimeOut, batchName);
				}
				_database.setCall(callTruncateSegundaFacturaConsolidadoFija);
				output.clear();
				input.clear();
				cs = _database.executeCallOutputs(_database.getConn(uid),
						output, input,uid);	
			...
			registrar_auditoriaV2("CONSOLIDADO FIJA", "Error generando reporte",wSLAuditoriaBatchAddress, wSLAuditoriaBatchTimeOut, batchName);
		} finally {
