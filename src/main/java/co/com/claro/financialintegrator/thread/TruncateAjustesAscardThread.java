...
public class TruncateAjustesAscardThread extends GenericProccess implements Job{
	private Logger logger = Logger.getLogger(TruncateAjustesAscardThread.class);
	 ...
	 */
	private boolean truncateAjustesAscard(String dataSource, String callTruncateAjustesAscard,String uid) throws FinancialIntegratorException{
		Database _database = getDatabase(dataSource);
		boolean estado= false;
		if (_database!=null){
			_database.setCall(callTruncateAjustesAscard);
			//
