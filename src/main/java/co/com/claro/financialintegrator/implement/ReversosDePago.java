 ...
 */
public class ReversosDePago extends GenericProccess {
	private Logger logger = Logger.getLogger(ReversosDePago.class);
	...
	public void process() {
		...
		logger.info(".. PROCESANDO BATCH REVERSOS DE PAGO ..");
		// TODO Auto-generated method stub
