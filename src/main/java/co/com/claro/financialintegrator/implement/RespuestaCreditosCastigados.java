...
public class RespuestaCreditosCastigados extends GenericProccess {

	private Logger logger = Logger.getLogger(RespuestaCreditosCastigados.class);

	@Override
	public void process() {
		logger.info(" -- PROCESANDO RESPUESTA CREDITOS CASTIGADOS --");
							...
							if (FileUtil.copy(fileNameFullPath, fileNameCopy)) {
								...
								try {
									...
									List<FileOuput> lines = FileUtil
											.readFile(this.configurationFileCreditosCastigadosAscard(fileOuput));
	...
	/**
	 * Configuración de archivo de creditos retirados para poder procesar el archivo
	 * de respuesta tomado de BSCS
	 * 
	 * @param file Archivo de creditos retirados
	 * @return
	 */
	private FileConfiguration configurationFileCreditosCastigadosAscard(String file) {
