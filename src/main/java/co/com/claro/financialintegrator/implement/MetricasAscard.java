...
public class MetricasAscard extends GenericProccess {
	private Logger logger = Logger.getLogger(MetricasAscard.class);
	...
	public void process() {
		...
		logger.info(".. PROCESANDO BATCH METRICAS ASCARD ..");
		// TODO Auto-generated method stub
