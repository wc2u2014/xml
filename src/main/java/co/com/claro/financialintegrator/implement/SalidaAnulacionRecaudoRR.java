...
public class SalidaAnulacionRecaudoRR extends GenericProccess {
	private Logger logger = Logger.getLogger(Cobranzas.class);
	...
	public void process() {
		...
		logger.info(".. PROCESANDO BATCH SALIDA ANULACION SICACOM ..");
		// TODO Auto-generated method stub
