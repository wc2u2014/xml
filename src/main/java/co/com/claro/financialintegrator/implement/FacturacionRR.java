 ...
 * 
 * @author Nestor_Zuluaga
 */

public class FacturacionRR extends GenericProccess {
	private Logger logger = Logger.getLogger(FacturacionRR.class);
	...
	public void process() {
		...
		logger.info(".. PROCESANDO BATCH FACTURACION ..");
		// TODO Auto-generated method stub
